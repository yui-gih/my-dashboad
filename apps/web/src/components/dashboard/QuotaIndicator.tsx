  ...
  return (
    <div className="rounded-xl border border-zinc-700/50 bg-gradient-to-b from-zinc-800/80 to-zinc-900 p-4 shadow-[0_4px_20px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.06)]">
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-xs font-mono text-zinc-300" suppressHydrationWarning>
      ...
      <p className="text-[10px] text-zinc-600 mt-1.5" suppressHydrationWarning>残り {remaining.toLocaleString()} units</p>
    </div>
  );
}
